...
int check_sort(double *mas, int *index, int len); // Функция проверки успешности сортировки
void fill_mas(double * mas1, double * mas2, int size); // Функция заполнения массива случайными числами
void output(double * timing, int N, double *mas1, double *mas2, int *index); // Функция вывода результата
